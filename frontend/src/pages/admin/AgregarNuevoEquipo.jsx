        ...
        <div className='flex justify-center items-center h-full mt-20'>
            <div className="border-green-600 border-[5px] p-10 shadow-sm rounded-3xl" style={{ backgroundColor: backgroundColorWithTransparency }}>
                <div className="flex items-center justify-center">
                    <p className="text-xl font-bold text-black text-center">Agregar Nuevo Equipo</p>
                </div>
                ...
                <div className="flex flex-col gap-4 my-10 paddin">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Input type={"password"} placeholder={"Cantidad equipo"} className="flex-grow text-black" />
                    </div>
...
export default AgregarNuevoEquipo