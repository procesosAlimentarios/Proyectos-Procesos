...
function EditarMaterial() {
    ...
    const backgroundColorWithTransparency = hexToRgba(styles.backgroundEditar, 0.5); // 0.5 es la transparencia deseada
    return (
            ...
            <div className="border-orange-600 border-[5px] p-10 shadow-sm rounded-3xl" style={{ backgroundColor: backgroundColorWithTransparency }}>
                ...
                <div className="flex flex-col gap-4 my-10 paddin">
                    <div className="flex items-center justify-between ">
                        ...
                        <Input type={"text"} placeholder={"Nombre material"} className="flex-grow" />
                    </div>
                    
                    <div className="flex items-center justify-between">
                        <p className='text-black w-32 font-semibold'>Cantidad:</p>
                        <Input type={"password"} placeholder={"Cantidad material"} className="flex-grow text-black" />
                    </div>
